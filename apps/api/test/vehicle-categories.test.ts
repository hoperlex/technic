...
describe('наименования категорий из сида 0046', () => {
  ...
  it('дробные значения — с точкой, целые — без хвостового нуля', () => {
    ...
    expect(
      nameOf('Вилочные погрузчики и минипогрузчики', [capacityT], [['lift_capacity', 1]]),
    ).toBe('Вилочные погрузчики и минипогрузчики, г/п 1 т');
    expect(
      nameOf('Вилочные погрузчики и минипогрузчики', [capacityT], [['lift_capacity', 3]]),
    ).toBe('Вилочные погрузчики и минипогрузчики, г/п 3 т');
  });
