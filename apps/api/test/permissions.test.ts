...
describe('служба главного механика: механик смотрит, главный механик ведёт', () => {
   ...
   */
  it('механик только читает: справочники, гараж, журнал листов и карточки водителей', () => {
    ...
    // Ни одного права, которое не кончается на `.read`: перечень выше сверяет состав, а это —
    // правило, по которому он собран (тот же приём, что у наблюдателя). Первое же действие,
    // выданное механику, обязано прийти сюда осознанно, а не добавкой к чтению.
