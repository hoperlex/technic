 ...
 *
 * ЭСМ2-РАЗРЕЗ. Границы листа здесь — реквизит, а не предмет: `2026-09-01…2026-09-05` это вторник и
 * суббота, то есть недельного допущения «лист = неделя от понедельника» фикстура не несёт даже
 * формой. Ни одно утверждение файла их не читает — проверяется доступ к файлу, а лист нужен лишь
 * как законный носитель связи. После перехода на отрезковое чтение вт–сб остаётся законным листом,
 * и переписывать тут нечего (реестр `esm2-week-registry.ts`).
 */
