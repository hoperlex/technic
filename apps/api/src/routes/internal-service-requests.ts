 ...
 *
 * ПОЛЕ ПОКА НИКТО НЕ ПИШЕТ — его выставит спор об освобождении (Э5), исходом разрешения: «оставить
 * освобождение» ставит момент разрешения, «нужна подпись» — момент подписи. Условие заложено
 * сейчас, а не вместе с писателем, потому что отбор созревших — единственное место, где сходятся
 * срок и наличие бумаги, и трогать его дважды дороже, чем один раз.
 *
