 ...
 * - `sheetSnapshotDraft` и `warningSnapshot` — их считает `prepareEsm2Issues`, и считает чтением
 *   справочников: карточка человека, его документы на дату листа, машина, объект и заказчик.
 *   Сверка теней гоняет расчёт на состоянии, которого в базе никогда не было (Е1), — читать по
 *   нему справочники нечем; вместо снимков сравниваются их входы — период, машина и человек, из
 *   которых снимок и собирается;
