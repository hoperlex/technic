...
// словами.
//
// Событий у модуля шесть, а не одно, и делятся они не по прихоти: у заявки меняются четыре разных
// сюжета — форма, договорённость, факт выдачи и факт возврата, — и сведи их к одной «правке», в
// истории не осталось бы ни «была ставка 1200/час, стала 1500», ни «выдачу отметили ошибочно,
// причина такая-то». Оба вопроса задают, разбирая счёт.
