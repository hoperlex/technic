 ...
 * подписи. Двумя числами — их хватает трём правилам сразу (закрытие заявки, смена машины,
 * предупреждение в срезе), а даты нужны только в тексте отказа и в самой таблице смен.
 *
...
/** Наступившие дни заказа без подписи — ими объясняется отказ закрыть заявку. */
