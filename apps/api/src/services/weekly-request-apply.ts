 ...
 *
 * Отдана наружу намеренно: тот же вопрос задаёт подача состава (маршрут недельных заявок), и
 * ответить на него в двух точках цикла по-разному нельзя — иначе строка, прошедшая подачу, отпадёт
 * на визе (или наоборот).
 */
