...
async function issueEsm2Waybill(
   ...
   * и узнавали об этом в бухгалтерии заказчика. Специализация из отбора убрана, и `null` остался
   * только у удалённой карточки; на неё лист не выписывается ни одним из входов.
   *
  ...
  if (!machinist) {
    throw err.unprocessable(
      'Машиниста нет в справочнике — его карточка удалена, и путевой лист на него не выписывается',
