...
describe('нижняя навигация на мобильном повторяет права роли', () => {
  ...
  // генератором на площадке заказывает он же (план механизации, Р9). Если заказчик читает своё
  // «права как у заказа автотехники» строже — модуль снимается одной строкой матрицы.
