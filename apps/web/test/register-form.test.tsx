 ...
 *
 * Обе ручки подменяются сетью, а не модулем `@entities/session`: «заявка не ушла» — утверждение
 * о том, что запроса не было, и проверять его подменённым модулем значит держаться за нынешнюю
 * раскладку файлов портала вместо HTTP-контракта регистрации.
 */
