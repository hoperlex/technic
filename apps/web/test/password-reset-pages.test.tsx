 ...
 *
 * Сеть подменяется на уровне HTTP, а не модулем `@entities/session`: «запрос не ушёл» —
 * утверждение о контракте восстановления, а не о нынешней раскладке файлов портала.
 */
