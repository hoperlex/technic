...
describe('вход приводит в раздел роли, а не на служебную форму', () => {
  it('оператор сервисной компании попадает в «Орг.техника», а не на смену пароля', async () => {
    ...
    /*
     * Временная заплатка (`src/auth/temporarySectionLock.ts`) прячет «Орг.технику» до запуска
     * модуля, но сервисную компанию из-под неё вывели отдельной строкой: раздел у этой учётки
     * единственный, и без него портал отвечал ей экраном «разделов нет».
     */
