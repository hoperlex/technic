...
describe('вход приводит в раздел роли, а не на служебную форму', () => {
  it('оператор сервисной компании попадает в «Орг.техника», а не на смену пароля', async () => {
    ...
    // Раздел у этой учётки единственный: промахнись стартовая страница мимо него — портал ответил
    // бы ей экраном «разделов нет» или формой смены пароля, с чего эта цепочка и начиналась.
