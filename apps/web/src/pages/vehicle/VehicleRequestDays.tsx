  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
      ...
      <Typography.Text type="secondary" style={{ fontSize: 12 }}>
        День ставят в рейс по одному, когда на него выходит своя машина или свой водитель; весь
        срок разом проходит «Распланировать период» — машиной назначения и одним человеком. Часы
