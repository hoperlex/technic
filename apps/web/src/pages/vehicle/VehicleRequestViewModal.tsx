          ...
          {request.requestType === 'special_equipment' ? (
            <Tabs
              items={[
                ...
                // площадке весь срок, и работа считается неделями, а не выездами. Своего права
                // у вкладки нет (ADR 0122): «кто и на чём выйдет ко мне в четверг» — вопрос
                // заказчика, а планирование дней держит `canPlan` внутри таблицы.
                ...(request.isLinear
                  ? [
                      {
                        key: 'days',
