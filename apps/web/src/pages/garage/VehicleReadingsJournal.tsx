...
/**
 * Литры топлива. Прироста и разности рядом нет намеренно (ADR 0163, Р1): остаток — уровень бака, а
 * расход смены считает сверка с нормой (ADR 0194) — в сводке и карточке, где рядом стоит норма.
 * Построчной сверки журнал не получил: он отвечает на «что сдали», а не на «уложились ли».
 */
