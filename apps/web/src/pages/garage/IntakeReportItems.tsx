      ...
      {reading.kind === 'no_data' ? (
        ...
        <Space size={24} wrap>
          ...
          {/* Три числа топлива идут группой и в порядке смены (ADR 0163, Р2): остаток бака на её
              начало, заправленное за неё, остаток на конец. Приростов у них нет намеренно: расход
              смены считает сверка с нормой (ADR 0194), и место ей — там, где рядом стоит норма, а
              не в разборе отчёта, где спрашивают «что сдали». */}
