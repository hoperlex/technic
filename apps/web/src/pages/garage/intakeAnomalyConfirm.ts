 ...
 *    показания. Оба остатка бака входят в тело наравне со счётчиками и без преобразований (ADR
 *    0163, Н6): в контракте они необязательны, и пропуск ключа сервер понял бы как «оставить как
        ...
        items: [
          {
            ...
            reading: {
              ...
              fuelStartLiters: reading.fuelStartLiters,
              fuelFilledLiters: reading.fuelFilledLiters,
              fuelEndLiters: reading.fuelEndLiters,
