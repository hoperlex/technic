      ...
      <div style={pageStyle}>
        <Card style={{ width: '100%', maxWidth: 520 }}>
          ...
          <Result
            ...
            subTitle={
              <>
                На адрес <b>{submittedEmail}</b> отправлено письмо со ссылкой — подтвердите, что
                ящик ваш. Пока адрес не подтверждён, администратор не сможет выдать доступ. Письма
                нет во «Входящих» — проверьте папку «Спам»; ссылку можно запросить заново на{' '}
                <Link to="/verify-email">странице подтверждения</Link>.
              </>
            }
            extra={
      ...
      <Card style={{ width: '100%', maxWidth: 480 }}>
        ...
        <Form form={form} layout="vertical" onFinish={onFinish} requiredMark={false}>
          ...
          {/* Телефон обязателен (ADR 0066): почтовых уведомлений у портала нет, и заявку на
              ...
              — иначе учётки, заведённые до этого правила, стали бы непроходимыми для правки. */}
          <PhoneField
            size="large"
            required
            extra="По нему администратор свяжется с вами по заявке — писем портал не шлёт"
          />
          <PasswordField
            name="password"
