...
const SHEETS: [string, string][] = [
  [
    'Свод',
    'строка на машину: смены по плану и сколько отчитались, пробег, наработка, актуальные одометр и моточасы с датами, заправлено, расход, разрывы, аномалии, водители и машинисты, нарекания. Строки без нареканий залиты зелёным и стоят сверху.',
  ],
  [
    'Детализация',
    'смены по каждой машине: заголовок с гос. номером и моделью, строки смен с приростами и топливом, итог по машине; смена попадает в книгу и тогда, когда показаний за неё не передавали. Смены сворачиваются кнопкой слева.',
  ],
  [
    'Сводная',
    'готовая сводная таблица: техника по строкам, месяцы по колонкам, значения — пробег, заправлено, расход. Разрезы по работнику и типу техники собираются мышью.',
  ],
  [
    'Параметры',
