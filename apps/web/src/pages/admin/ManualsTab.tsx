 ...
 *
 * API берётся прямо из `@entities/manual`: так вкладка и завелась — мимо общего реестра ручек,
 * который тогда занимал весь свой бюджет строк и ждал разреза. Реестра больше нет, а привычка
 * брать ручки у своего слайса осталась правилом.
 */
