...
export function wasteFiltersBar(o: Options): ReactNode {
  return (
    <Space size={[12, 8]} wrap>
      {/* Поле остаётся узким — панель от этого не разъезжается, — а раскрытый список сам шире
          поля: подпись площадки с адресом длиннее любого разумного фильтра, и обрезанная в
          многоточие она перестаёт отвечать на «та ли это площадка». Ширина списка здесь больше не
          прописана: правило одно на портал и живёт в корневом провайдере (ADR 0136). */}
      <Select
        style={{ width: 240 }}
