  ...
  return {
    ...
    field: axis && (
      <Form.Item
        ...
        // Подпись вопросом, а не именем реквизита (Р17): спрашивают у человека, откуда он, — и ось
        // выбора («отдел» или «площадка») видна по самому списку, а не по заголовку поля.
        label="Откуда обращаетесь"
        extra={
          axis === 'department'
