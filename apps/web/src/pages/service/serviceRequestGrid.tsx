...
import { ServiceStatusLineCell } from './ServiceStatusCell';
      ...
      render: (_v: unknown, r: ServiceRequestDto) => (
        <div style={{ lineHeight: 1.35 }}>
          <Space size={4} wrap>
            ...
            {/* «Без согласования» — там же, а не в столбце «Сумма» (Р13 плана освобождения от
                подписи): столбец денег виден не всякому и не на всяком наборе колонок, а тег
                обязан попадаться на глаза каждому, кто ведёт заявки. Рядом с номером — потому что
                по номеру заявку и берут в разговор с подрядчиком. */}
