...
/**
 * Окончательное удаление погашенной записи (ADR 0060) — одинаково во всех вкладках: справочники и
 * учётные записи (ADR 0063).
 *
 ...
 *
 * Живёт в `hooks/`, а не в слайсе справочников: учётки ведутся в другом разделе портала, и импорт
 * между слайсами одного слоя запрещён разметкой границ.
 *
