 ...
 * отдела — площадка её отдела. Устроена как `useObjectScope` и отвечает на те же три вопроса:
 * чем сузить список объектов, чем заполнить поле и когда его запереть.
 *
