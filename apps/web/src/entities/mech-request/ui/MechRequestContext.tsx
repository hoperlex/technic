...
import { mechRequesterLabel, mechTermLabel } from '../model/labels';
 ...
 * виброплиту: их различают номер, вид, площадка и срок — ровно эти четыре и стоят здесь.
 *
  ...
  return (
    <div style={{ lineHeight: 1.4, marginBottom: 12 }}>
      <Typography.Text strong>
        {request.displayNumber} · {request.kindName}
      </Typography.Text>
