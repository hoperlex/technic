 ...
 *
 * Загрузка файла в хранилище приходит параметром: живёт она в `@entities/file`, а слайсу тянуть
 * соседа по слою разметка границ не даёт — вход туда есть у features и pages, и они его и передают.
 */
