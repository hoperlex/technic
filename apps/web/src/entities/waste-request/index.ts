 ...
 * `pages/WasteRequestsPage.tsx` и её вкладках. Там же пока и собираются ключи — строками, теми же
 * кортежами, что объявлены здесь: экраны переходят на семейства отдельной правкой, потому что
 * сдвинуть ячейку кэша заодно с раскладкой значило бы менять поведение под видом переноса, а такую
 * правку видно только глазами на экране.
 */
