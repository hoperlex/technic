...
const ALLOWED = {
  ...
  // Задание водителя — вторая страница кабинета, а не раздел портала: тот же гейт, тот же каркас и
  // та же дата в адресе (план driver-readings-first, Р1). Путь относительный — он вложен в `/driver`.
  assignment: 'задание водителя — вторая страница кабинета внутри его же ветки',
