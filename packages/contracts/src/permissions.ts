...
export const ROLE_PERMISSIONS: Record<Role, readonly Permission[]> = {
   ...
   *
   * Механик — чтение. Справочники (техника со всем, что к ней привязано: виды, типы, модели, ТТХ,
   * категории; плюс объекты и отделы) открывает `directories.read`, парк на дату — `garage.read`,
   * журнал листов с печатью — `waybills.read`, карточки водителей — `drivers.read`.
   *
   ...
   */
  mechanic: ['directories.read', 'garage.read', 'waybills.read', 'drivers.read'],
