...
export const ROLE_ADDON_PERMISSIONS: Record<RoleAddon, readonly Permission[]> = {
  office_equipment_operator: [
     ...
     * (Р5 плана — этап Э6 расширяет `grant_roles` на менеджера и диспетчера), барьер требований
  ...
  /**
   * Согласование ИТ (Р51, Р54) и КООРДИНАЦИЯ модуля: сверх набора действий она расширяет и
   * **область** — модуль виден ей целиком (`ADDON_MODULE_WIDE_SCOPE`), и это свойство кода набора,
   * а не его состава.
   *
