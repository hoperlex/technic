...
/**
 * Машина, которой линейный заказ работает в день среза (ADR 0100 §4): машина **рейса этого дня**, а
 * не машина назначения. У линейной техники это разные ответы — назначение всего лишь машина по
 * умолчанию, а на объект во вторник выходит та, чьим рейсом вторник закрыт, — и срез обязан
 * называть фактическую: он отвечает на вопрос «что сейчас стоит на площадке».
 *
