...
export const serviceRequestStatusLabels: Record<ServiceRequestStatus, string> = {
  new: 'Новая',
  // legacy: снимается выпуском 2. Подпись оставлена прежней — она описывает то, чем эти строки и
  // были: заявку со входной визой ИТ. Переименуй мы её в «Новая», два разных состояния слились бы
  // в списке, и заявку, застрявшую в мёртвом статусе, стало бы не видно.
