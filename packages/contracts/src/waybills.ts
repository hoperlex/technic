...
export interface WaybillDto {
  ...
  /**
   * Лист прошёл через операцию коррекции (ADR 0101 п. 18) — родился ею или был ею списан.
   *
...
export const waybillListQuerySchema = baseListQuery(WAYBILL_SORT_FIELDS).extend({
  ...
  /**
   * Только коррекции — седьмой фильтр журнала (Р28, ADR 0101 п. 18). Им бухгалтерия читает, что
