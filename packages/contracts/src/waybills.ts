...
export const WAYBILL_SNAPSHOT_KEYS = [
   ...
   *
   * Разобранные графы рядом — для формы № 3: её оборот держит таблицу на десять строк, и заявки
   * 5–10 встают там штатными колонками, как 2–4. Контакты в ней графы не имеют вовсе — у рейсов
   * 5–7 они живут только внутри строки 4-П.
   */
  'task5_customer',
  'task5_from',
  'task5_to',
  ...
  'task7_line',
  /*
   * Рейсы 8–10 — только форма № 3: в 4-П места под них нет, и `*_line` у них поэтому не бывает.
   * Ёмкость маршрута задаёт его бланк (`ROUTE_REQUEST_CAPACITY`), так что до восьмой строки
   * доходят лишь рейсы легкового.
   */
  'task8_customer',
  'task8_from',
  'task8_to',
