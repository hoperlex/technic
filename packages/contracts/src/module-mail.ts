 ...
 *
 * Все три события — про заявку на обслуживание оргтехники, и все три привязаны не к действию ручки,
 * а к **входу заявки в статус**: «Новая» бывает не только у только что заведённой заявки, но и у
...
export const moduleMailOutcomeLabels: Record<ModuleMailOutcome, string> = {
  ...
  no_recipients:
    'Некому отправить письмо: ни у назначенных, ни у сервисной компании нет адреса — ' +
    'предупредите их сами и заведите ящик компании в справочнике контрагентов',
