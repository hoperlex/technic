...
> **Статус на 14.09.2026: к работе не приступали.** Сверка `grep` по `apps/` и `packages/` не
> находит ни одного упоминания Контура, ЭПЛ, титулов и подписи — ни кода, ни таблиц, ни контрактов.
> Разработку держат решения §14: контур КЭП и подписант Т1, канал оформления Т3, судьба бумажного
> листа на переходный период.
