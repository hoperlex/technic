...
function header(page, titleValue, kicker, subtitle) {
  ...
  if (subtitle)
    output += paragraph(55, 160, subtitle, 1005, 16, {
      fill: C.muted,
      lineHeight: 23,
      maxLines: 2,
    });
...
function page1() {
  ...
  b += text(121, 73, 'АВТО • ПОРТАЛ • ОРГ.ТЕХНИКА', 16, {
    fill: C.blue,
    weight: 700,
    letter: 1.45,
  });
  ...
  b += bullet(
    82,
    1246,
    'ИТ-специалисту — вести назначенные заявки и предъявлять объём работ.',
    450,
    {
      color: C.purple,
      size: 16,
  ...
  b += bullet(
    565,
    1246,
    'Тому, кто следит за полкой, — остаток, потребность и плановые закупки.',
    450,
    {
      color: C.orange,
      size: 16,
...
function page2() {
  ...
  b += pill(cx + 132, 356, 'Требуют решения', {
    fill: C.graySoft,
    color: C.text,
    stroke: '#d9d9d9',
    size: 13,
  }).svg;
  b += pill(cx + 314, 356, 'Срочные', {
    fill: C.graySoft,
    color: C.text,
    stroke: '#d9d9d9',
    size: 13,
  }).svg;
  b += pill(cx + 428, 356, 'Ожидаются документы', {
    fill: C.graySoft,
    color: C.text,
    stroke: '#d9d9d9',
    size: 13,
  }).svg;
  b += button(cx + cw - 192, 246, 192, 'Создать заявку', {
    compact: true,
    primary: true,
    icon: '+',
  });
  ...
  b += tableRow(
    ...
    462,
    widths,
    ['СО-412', 'Новая', 'Ricoh MP 201SPF', 'АЛ13 · Бухгалтерия', '—', '2 дня'],
    { fill: '#fcfdff' },
  );
  b += tableRow(cx, 517, widths, [
    'СО-410',
    'В работе',
    'Kyocera M3145',
    'АЛ14 · ИТ',
  ...
  b += tableRow(
    ...
    572,
    widths,
    ['СО-407', 'Решена', 'Без аппарата', 'Отдел кадров', 'ИТ-служба', '1 день'],
    { fill: '#fcfdff' },
  );
  b += tableRow(cx, 627, widths, [
    'СО-401',
    'Отложена',
    'Pantum P2500W',
    'АЛ13 · приёмная',
  ...
  b += text(cx, 718, '1–20 из 64 · по умолчанию сверху то, что ждёт дольше всех', 13, {
    fill: C.muted,
  });
  b += shell.close;
  ...
  const tabCards = [
    [
      'Заявки',
      'Что чинится и чего не хватает сейчас: рабочий список с очередями и карточкой заявки.',
      C.blue,
      C.bluePale,
      '#bae0ff',
    ],
    [
      'Гарантии',
      'Что ещё покрыто гарантией — и на технику, и на выполненные ремонты.',
      C.cyan,
      C.cyanSoft,
      '#87e8de',
    ],
    [
      'Архив',
      'Что было: удалённые заявки, их возврат и окончательное удаление.',
      C.faint,
      C.graySoft,
      '#d9d9d9',
    ],
    [
      'Техника',
      'Где что стоит, что уехало в ремонт и по чему истекает гарантия.',
      C.green,
      C.greenSoft,
      '#b7eb8f',
    ],
    [
      'Расходники',
      'Чего не хватает на складе: остаток, потребность, дефицит и закупки.',
      C.purple,
      C.purpleSoft,
      '#d3adf7',
    ],
  ...
  b += tableRow(
    ...
    1316,
    vwidths,
    ['Архив', 'Отдельным доступом к архиву поверх права на заявки', 'Архив вашей роли не положен'],
    { fill: '#fcfdff', weights: [600] },
  );
  b += paragraph(
    82,
    1400,
    'Сервисной компании открыты заявки и не открыт парк: реквизиты нужного ей аппарата приходят снимком в самой заявке.',
    940,
    13,
...
function page3() {
  ...
  b += paragraph(
    82,
    364,
    'Здесь заводят, правят и архивируют карточки техники. Отсюда же открываются три окна номенклатуры.',
    436,
    14,
    { fill: C.text, lineHeight: 21 },
  );
  b += bullet(82, 432, 'Добавить технику, поправить реквизиты, снять «Активна».', 436, {
    color: C.blue,
    size: 14,
    lineHeight: 20,
  });
  b += bullet(82, 486, '«Типы оргтехники» — МФУ, принтер, сканер и прочие виды.', 436, {
    color: C.blue,
    size: 14,
    lineHeight: 20,
  });
  b += bullet(
    82,
    540,
    '«Модели аппаратов» — единые названия, из которых выбирают в карточке.',
    436,
    { color: C.blue, size: 14, lineHeight: 20 },
  );
  b += bullet(
    82,
    600,
    '«Картриджи и тонеры» — заведение позиции, цвет, совместимость, гашение и удаление.',
    436,
    { color: C.blue, size: 14, lineHeight: 20 },
  );
  ...
  b += paragraph(
    605,
    364,
    'Здесь той же номенклатурой пользуются: заводят заявки, смотрят парк, правят полку и заказывают.',
    436,
    14,
    { fill: C.text, lineHeight: 21 },
  );
  b += bullet(605, 432, 'Завести заявку на обслуживание или на расходники.', 436, {
    color: C.green,
    size: 14,
    lineHeight: 20,
  });
  b += bullet(605, 486, 'Посмотреть, где аппарат стоит, и записать его переезд.', 436, {
    color: C.green,
    size: 14,
    lineHeight: 20,
  });
  b += bullet(605, 540, 'Изменить остаток, задать потребность, прочитать журнал движений.', 436, {
    color: C.green,
    size: 14,
    lineHeight: 20,
  });
  b += bullet(605, 600, 'Завести плановую закупку по дефициту.', 436, {
    color: C.green,
    size: 14,
    lineHeight: 20,
  });
  ...
  const rows = [
    [
      'Завести аппарат или поправить его карточку',
      'Справочники → Оргтехника',
      '«Оргтехника: ведение»',
      '#fcfdff',
    ],
    [
      'Завести тип, модель или картридж',
      'Справочники → Оргтехника, три окна',
      '«Ведение», «Номенклатура»',
      '#fff',
    ],
    ['Завести заявку', 'Орг.техника → Заявки', 'Всем, кому открыты заявки', '#fcfdff'],
    [
      'Узнать, где стоит аппарат, записать переезд',
      'Орг.техника → Техника',
      'Всем, кому открыта техника',
      '#fff',
    ],
    [
      'Поправить остаток или потребность',
      'Орг.техника → Расходники',
  ...
  b += text(82, 1204, 'Почему на вкладке «Расходники» нельзя завести позицию', 18, {
    fill: C.orange,
    weight: 700,
  });
  b += paragraph(
    82,
    1240,
    'Это не недоделка, а та же граница. Вкладка отвечает на вопрос «чего не хватает и что заказать», а новый код номенклатуры — это ведение справочника: его заводят один раз и там, где следят за уникальностью кода. Кнопка «Добавить расходник» живёт в окне «Картриджи и тонеры».',
    950,
    15,
    { fill: C.text, lineHeight: 23 },
  );
  ...
  b += paragraph(
    82,
    1412,
    'Перечень позиций в справочнике и на вкладке показывает одно и то же — код, наименование, цвет, наличие, потребность, совместимость. Различаются только действия строки: в справочнике есть заведение и удаление, на вкладке — потребность и закупка.',
    950,
    14,
...
function page4() {
  ...
  b += text(142, 1184, 'Сквозная область ИТ-службы работает только в оргтехнике', 22, {
    fill: C.ink,
    weight: 700,
  });
  b += paragraph(
    142,
    1216,
    'Это не оговорка мелким шрифтом, а устройство: согласующий, видящий только свой отдел, не смог бы решать по заявкам всей компании — а видеть заодно каждый вывоз мусора ему незачем.',
    900,
    14,
    { fill: C.muted, lineHeight: 21 },
  );
  ...
  b += paragraph(
    106,
    1336,
    'Видны все заявки и весь парк компании, независимо от площадки и отдела учётки.',
    424,
    14,
    { fill: C.text, lineHeight: 21 },
  );
  ...
  b += paragraph(
    595,
    1336,
    'Всё как у обычной учётки этой роли: своя площадка или свой отдел, не больше.',
    424,
    14,
    { fill: C.text, lineHeight: 21 },
  );
...
function page5() {
  ...
  const grants = [
    ...
    },
    {
      ...
      points: [
        ...
        'Предъявляет объём работ под сервисной компанией, заполняет расходники заявки.',
  ...
  b += bullet(
    82,
    1318,
    'ИТ-служба не принимает работу и не отменяет заявку: приёмка и отмена остаются за «Ведением» — иначе исполнитель принимал бы собственную работу.',
    940,
    { color: C.orange, size: 14, lineHeight: 20 },
  );
  b += bullet(
    82,
    1382,
    '«Ведение» не предъявляет объём работ: его пишет исполнитель, а согласует ведущий. Одному человеку оба права дали бы подпись под собственным счётом.',
    940,
    { color: C.orange, size: 14, lineHeight: 20 },
  );
...
function page6() {
  ...
  b += input(82, 760, 581, 'Откуда обращаетесь', 'Ваша площадка', {
    placeholder: true,
    suffix: '⌄',
  });
  ...
  b += input(82, 976, 581, 'Что ещё важно знать', 'Необязательно', {
    placeholder: true,
    height: 64,
  });
  ...
  b += callout(
    ...
    190,
    '1',
    'Вид — первым и навсегда',
    '«Обслуживание» — это не только поломка: им же просят настроить, подключить и заправить. «Расходники» — просьба привезти картридж.',
    { fill: C.bluePale, stroke: '#bae0ff' },
  );
  b += callout(
    715,
    428,
    ...
    190,
    '2',
    'Аппарат обычно обязателен',
    'Заявка живёт на аппарате: его объектом и отделом она попадает в чью-то область. Пропустить поле могут только «Ведение» и ИТ-служба — см. стр. 13.',
    { fill: C.purpleSoft, stroke: '#d3adf7', dotFill: C.purple },
  );
  b += callout(
    715,
    634,
    ...
    '3',
    'Описание — словами',
    'Одно поле у обоих видов. Расходники заявки заявитель не подбирает: состав заполнит исполнитель, которому везти.',
    { fill: C.greenSoft, stroke: '#b7eb8f', dotFill: C.green },
  );
  b += callout(
    715,
    840,
    ...
    '4',
    'Два разных «откуда»',
    '«Для кого заявка» — от чьего имени просят, «Откуда обращаетесь» — где числится сам заявитель. Путать их значит записать заявку на чужой отдел.',
    { fill: C.cyanSoft, stroke: '#87e8de', dotFill: C.cyan },
  );
  b += callout(
    715,
    1046,
    ...
    208,
    '5',
    'Срочность — с причиной',
    'Галочка без объяснения не сохраняется: без причины через месяц срочными окажутся все заявки, и очередь перестанет что-либо значить. Снять и поставить срочность потом может «Ведение».',
    { fill: C.orangeSoft, stroke: '#ffd591', dotFill: C.orange },
  );
  ...
  b += paragraph(
    82,
    1368,
    'Блок обращения по гарантии показывается только у «Обслуживания» и только когда аппарат выбран: обращаются либо по гарантии поставщика на него, либо по работе, выполненной на нём же. У заявки на расходники и у заявки без аппарата такого блока нет вовсе.',
    950,
    15,
    { fill: C.muted, lineHeight: 22 },
  );
  b += footer();
  return document(b);
}
...
function page7() {
  ...
  steps.forEach((step, i) => {
    ...
    b += paragraph(160, y + 76, step.body, 600, 13.5, {
      fill: C.muted,
      lineHeight: 20,
      maxLines: 3,
    });
    b += pill(800, y + 26, step.who.toUpperCase(), {
      fill: step.soft,
      color: step.color,
      size: 11,
      pad: 10,
  ...
  b += text(
    82,
    1262,
    'Заявка на расходники идёт тем же путём, но состав в ней называет исполнитель',
    20,
  ...
  b += paragraph(
    82,
    1296,
    'Заявитель говорит словами: «закончился чёрный тонер, печатать нечем». Позиции справочника подбирает тот, кому везти, — действием «Заполнить расходники» в карточке. Заказчик состав видит и не правит.',
    950,
    15,
    { fill: C.text, lineHeight: 22 },
  );
  b += bullet(
    82,
    1372,
    'Выдачу отмечают при закрытии работ — тогда же остаток и уменьшается.',
    470,
    { color: C.purple, size: 14, lineHeight: 20 },
  );
  b += bullet(565, 1372, 'Объёма работ у этого вида нет: согласовывать нечего и не у кого.', 470, {
    color: C.purple,
    size: 14,
    lineHeight: 20,
  });
...
function page8() {
  ...
  b += statusBox(82, 502, 190, 92, 'Отложена', 'движение остановлено с причиной', {
    color: C.muted,
    soft: '#fff',
    stroke: '#d9d9d9',
  });
  b += paragraph(
    292,
    530,
    'Откладывают и возобновляют «Ведение» и ИТ-служба. Причина обязательна всегда.',
    226,
    13,
    { fill: C.muted, lineHeight: 19, maxLines: 5 },
  );
  b += paragraph(
    82,
    626,
    '«Возобновить» возвращает заявку ровно в тот статус, из которого её отложили. Оператору сервисной компании заморозка закрыта: «ждём запчасть» не должно становиться решением подрядчика.',
    436,
    13,
    { fill: C.text, lineHeight: 19 },
  );

  b += rect(578, 440, 490, 250, { fill: C.redSoft, stroke: '#ffccc7', r: 14 });
  b += text(605, 484, 'Обрыв', 20, { fill: C.ink, weight: 700 });
  b += statusBox(605, 502, 190, 92, 'Отменена', 'снята с причиной, ходов нет', {
    color: C.red,
    soft: '#fff',
    stroke: '#ffccc7',
  });
  b += paragraph(
    815,
    528,
    'Отменяют из «Новой», «В работе» и «Отложена». Сюда же ведёт отказ по объёму работ — с причиной и решением, что делаем вместо.',
    226,
    13,
    { fill: C.muted, lineHeight: 19, maxLines: 6 },
  );
  b += paragraph(
    605,
    630,
    'Отменённая заявка не удалена: она остаётся историей того, что просили и почему не сделали.',
    436,
    13,
    { fill: C.text, lineHeight: 19 },
  );
  ...
  const rows = [
    ...
    [
      'Новая · В работе · Отложена → Отменена',
      'Отменить заявку (причина обязательна)',
      '«Оргтехника: ведение»',
    ],
    [
      'В работе → Отменена',
      'Не согласовать объём работ (причина и решение)',
      '«Ведение» или назначенный исполнитель',
    ],
  ...
  b += paragraph(
    55,
    1372,
    'Назначение исполнителей и отказ от заявки переходами не являются: они меняют состав, а не статус. Заявка остаётся «Новой» — и именно поэтому «Новая» отвечает то «распределите меня», то «возьмите меня в работу».',
    1013,
    14,
    { fill: C.muted, lineHeight: 21 },
  );
...
function page9() {
  ...
  const dead = [
    [
      'Назначена',
      'Означала «распределивший уже нажал, а исполнитель ещё нет». Это не состояние работы, а ожидание нажатия: аппарат не чинился быстрее оттого, что заявка стоит здесь. Сегодня то же самое видно по составу исполнителей.',
    ],
    [
      'Смета на согласовании',
      'Означала «объём работ предъявлен, решения нет». Заявка при этом была в работе — и сегодня остаётся «В работе», а ожидание подписи портал держит признаком, а не статусом.',
    ],
    [
      'Согласована ИТ',
      'Виза ИТ упразднена: подпись под работой теперь одна. Вопрос «чинить или менять» задаёт себе тот же человек, который смотрит на объём работ.',
    ],
    [
      'Диагностика',
      'Снята раньше, вместе с прежней разбивкой цикла. Работы по осмотру идут в «В работе», как и любые другие.',
    ],
  ];
  dead.forEach((item, i) => {
    const y = 262 + i * 152;
    ...
    b += pill(92, y + 62, 'В ЦИКЛЕ НЕ УЧАСТВУЕТ', {
      fill: '#fff',
      color: C.faint,
      stroke: '#d9d9d9',
      size: 10,
  ...
  b += paragraph(
    82,
    968,
    'Слей мы «Назначена» с «Новой» одним словом, два разных состояния слились бы в ленте истории — ровно там, где их и различают. История переходов не переписывается ни строкой: она рассказывает, как заявка шла на самом деле, а не как она шла бы по сегодняшним правилам.',
    950,
    15,
    { fill: C.text, lineHeight: 22 },
  );
  ...
  b += bullet(82, 1206, '«Все заявки» — весь список в вашей области.', 436, {
    color: C.blue,
    size: 14,
    lineHeight: 20,
  });
  b += bullet(82, 1258, '«Требуют решения» — те, где ход за вами.', 436, {
    color: C.blue,
    size: 14,
    lineHeight: 20,
  });
  b += bullet(82, 1310, '«Срочные» — с той самой галочкой и причиной.', 436, {
    color: C.blue,
    size: 14,
    lineHeight: 20,
  });
  b += bullet(82, 1362, '«Ожидаются документы» — закрыть работы нечем.', 436, {
    color: C.blue,
    size: 14,
    lineHeight: 20,
  });
  b += paragraph(82, 1412, 'Умолчание списка — сверху то, что ждёт дольше всех.', 436, 13, {
    fill: C.muted,
    lineHeight: 19,
  });
  ...
  b += paragraph(
    605,
    1198,
    'Показывает возраст текущего ожидания, а не возраст статуса. Передали заявку другому исполнителю — счётчик пошёл заново, даже если статус не менялся.',
    436,
    14,
    { fill: C.muted, lineHeight: 21 },
  );
  ...
  b += paragraph(
    627,
    1348,
    'Без исполнителей она ждёт распределения, с исполнителями — что за неё возьмутся. Подпись шага в карточке об этом и говорит.',
    392,
    13,
    { fill: C.muted, lineHeight: 19 },
  );
...
function page10() {
  let b = header(
    ...
    'Раньше это называлось сметой. Сегодня «Объём работ» — документ внутри заявки сервисной компании: исполнитель говорит, на какую сумму собирается сделать, а ведущий заявку соглашается или нет.',
  );
  ...
  b += tableRow(82, 392, widths, ['Замена термоблока', '1', '8 400', '8 400'], {
    height: 44,
    fill: '#fcfdff',
    size: 12,
    top: 27,
  });
  b += tableRow(82, 436, widths, ['Ролик захвата бумаги', '2', '950', '1 900'], {
    height: 44,
    size: 12,
    top: 27,
  });
  b += tableRow(82, 480, widths, ['Работа мастера', '2 ч', '1 200', '2 400'], {
    height: 44,
    fill: '#fcfdff',
    size: 12,
    top: 27,
  ...
  b += callout(
    ...
    220,
    '1',
    'Предъявляет исполнитель',
    'Кнопка «Объём работ» в карточке: заполнил состав — предъявил. Пока предъявление висит, ни изменить его, ни предъявить второй раз нельзя, и передать заявку другому исполнителю тоже.',
    { fill: C.bluePale, stroke: '#bae0ff' },
  );
  b += callout(
    705,
    ...
    '2',
    'Подписывают двое',
    'Согласовать может «Ведение» либо поимённо назначенный исполнитель — так решил заказчик. Оператор сервисной компании исключён раньше обеих веток: объём предъявил он, и подпись под собственным счётом это не согласование, а его копия.',
    { fill: C.greenSoft, stroke: '#b7eb8f', dotFill: C.green },
  );
  ...
  b += paragraph(
    142,
    796,
    'Прежняя «Смета на согласовании» означала не состояние работы, а ожидание нажатия кнопки. Аппарат не переставал быть сломанным, пока смотрят на сумму, и не чинился быстрее оттого, что заявка стоит в отдельном статусе.',
    900,
    15,
    { fill: C.text, lineHeight: 22 },
  );
  b += paragraph(
    142,
    872,
    'Поэтому заявка остаётся «В работе», а то, что ждут подписи, портал показывает подписью шага и очередью «Требуют решения». Согласие статуса не меняет вовсе.',
    900,
    15,
    { fill: C.muted, lineHeight: 22 },
  );
  ...
  const outcomes = [
    [
      'Согласовано',
      'Заявка остаётся «В работе», ход возвращается к исполнителю. Подпись привязана к редакции объёма: предъявили заново — прежнее согласие уже не считается.',
      C.green,
      C.greenSoft,
      '#b7eb8f',
    ],
    [
      'Не согласовано',
      'Заявка уходит в «Отменена». Спрашивают два разных вопроса: причину — почему не согласны, и решение — что делаем вместо. Решение видно в карточке отменённой заявки.',
      C.red,
      C.redSoft,
      '#ffccc7',
    ],
    [
      ...
      'Отзывает предъявление и снимает подпись, если она уже стояла. Нажимает сторона исполнителя: после этого состав снова правят и предъявляют заново.',
      C.blue,
      C.bluePale,
      '#bae0ff',
    ],
  ...
  b += text(82, 1338, 'Объём работ есть не у всякой заявки', 17, { fill: C.ink, weight: 700 });
  b += paragraph(
    82,
    1370,
    'У расходников его нет: картридж берут со своего склада, согласовывать нечего и не у кого, а вместо него — «Заполнить расходники». Нет его и у ремонта, который ведёт свой сотрудник: такую заявку закрывают датой выполнения и необязательным «Что сделали», стоимость внутренних работ не фиксируется.',
    950,
    14,
    { fill: C.muted, lineHeight: 21 },
  );
...
function page11() {
  ...
  blocks.forEach((block) => {
    ...
    b += paragraph(block.x + 24, 344, block.lead, 283, 14, {
      fill: C.muted,
      lineHeight: 20,
      maxLines: 3,
    });
  ...
  b += paragraph(
    82,
    972,
    '«Отказаться от заявки» снимает с неё вас (или вашу компанию) и статуса не меняет: заявка остаётся «Новой» и ждёт нового распределения. Если исполнителей было трое, а отказался один, работа никуда не передана — счётчик ожидания не обнуляется.',
    950,
    15,
    { fill: C.text, lineHeight: 22 },
  );
  b += paragraph(
    82,
    1052,
    'Отказа «я уже взялся, но передумал» в портале нет: такую заявку возвращает в «Новую» только откат «Вернуть в «Новую»» — смена исполнителя статуса не трогает (ADR 0187).',
    950,
    14,
    { fill: C.muted, lineHeight: 21 },
  );
  ...
  b += paragraph(
    142,
    1212,
    'Почти всё в модуле отматывается — на то и откаты. Необратимых действий два, и оба про удаление, а не про статус.',
    900,
    15,
    { fill: C.text, lineHeight: 22 },
  );
  ...
  b += paragraph(
    106,
    1332,
    'Удалённая заявка сперва уходит в архив, и оттуда её возвращает «Восстановить». Окончательное удаление из архива не отменяется ничем.',
    424,
    13.5,
    { fill: C.text, lineHeight: 20 },
  );
  ...
  b += paragraph(
    595,
    1332,
    'Лента не правится и не подчищается. Ошибочный ход исправляют новым ходом — он встанет в историю рядом, вместе с причиной.',
    424,
    13.5,
    { fill: C.text, lineHeight: 20 },
  );
...
function page12() {
  ...
  b += callout(
    ...
    '1',
    'Кому это положено',
    'Пропустить «Какой аппарат» могут только держатели наборов «Оргтехника: ведение» и «Оргтехника: ИТ-служба». Остальным поле обязательно, и это не строгость ради строгости — см. пункт 2.',
    { fill: C.bluePale, stroke: '#bae0ff' },
  );
  b += callout(
    683,
    ...
    234,
    '2',
    'Заказчик — по своей оси',
    'Роли площадки предлагаются её объекты, роли отдела — её отделы, ИТ-службе со сквозной областью — и то и другое. Иначе заявка ушла бы в чужую область и пропала бы у самого автора сразу после отправки.',
    { fill: C.purpleSoft, stroke: '#d3adf7', dotFill: C.purple },
  );
  ...
  const rows = [
    ...
    [
      'В гарантиях',
      'Обращения по гарантии у неё не бывает: гарантия — свойство конкретного аппарата.',
    ],
    [
      'В отборе ИТ-службы',
      'Пометки «аппарат стоит не на том объекте» тоже не бывает: сравнивать не с чем.',
    ],
    [
      'В области видимости',
      'Заявка попадает в область только через заказчика — того самого, которого назвали в форме.',
    ],
  ];
  rows.forEach((row, i) => {
  ...
  b += text(82, 1148, 'Почему рядовому заявителю аппарат обязателен', 20, {
    fill: C.green,
    weight: 700,
  });
  b += paragraph(
    82,
    1182,
    'Область видимости заявки считается по трём вещам: аппарату, его объекту и его отделу. Пока аппарат выбран, заявка попадает к нужным людям сама — даже если заказчиком случайно назвали не тот отдел. Без аппарата единственной опорой остаётся заказчик, и ошибка в нём означает заявку, которой не видит никто, включая её автора.',
    950,
    15,
    { fill: C.text, lineHeight: 22 },
  );
  b += paragraph(
    82,
    1284,
    'Поэтому свободный выбор здесь и не открыт: ось предлагается та же, по которой человек и так работает.',
    950,
    14,
    { fill: C.muted, lineHeight: 21 },
  );
  ...
  b += paragraph(
    82,
    1402,
    'ИТ-служба нередко оформляет заявку сама — за того, кто позвонил. Тогда состав расходников она заполняет сразу, не дожидаясь распределения: два шага там, где хватает одного, никому не нужны.',
    950,
    14,
    { fill: C.muted, lineHeight: 21 },
  );
...
function page13() {
  ...
  b += pill(590, 292, '□  Нет в наличии', {
    fill: C.redSoft,
    color: C.red,
    stroke: '#ffccc7',
    size: 12,
  }).svg;
  b += pill(759, 292, '□  Только активные', {
    fill: C.greenSoft,
    color: C.green,
    stroke: '#b7eb8f',
    size: 12,
  ...
  b += tableRow(
    ...
    390,
    widths,
    ['Д0000337741', 'Тонер Ricoh 201 (шт)', '—', '12', '20', '3', 'Активен', '✎  №  ⏱  ×'],
    { height: 48, fill: '#fcfdff', top: 24, weights: [500, 600] },
  );
  b += tableRow(
    82,
    438,
    widths,
    ['Б0000014256', 'Картридж Ricoh Type 1270D', 'чёрный', '0', '6', '2', 'Активен', '✎  №  ⏱  ×'],
    { height: 48, top: 24, colors: [C.text, C.text, C.text, C.red] },
  );
  b += tableRow(
    82,
    486,
    widths,
    ['Д0000341142', 'Тонер Ricoh MP C2503', 'голубой', '2', '—', '1', 'Активен', '✎  №  ⏱  ×'],
    { height: 48, fill: '#fcfdff', top: 24 },
  );
  b += tableRow(
    82,
    534,
    widths,
    ['Д0000341143', 'Тонер Ricoh MP C2503', 'жёлтый', '0', '—', '1', 'Погашен', '✎  №  ⏱  ×'],
    {
      height: 48,
      top: 24,
      fill: C.graySoft,
      colors: [C.text, C.text, C.text, C.red, C.faint, C.text, C.faint],
    },
  );
  ...
  b += paragraph(
    82,
    604,
    'Прочерк в «Цвете» — это ответ «у чёрно-белой позиции цвета не бывает», а не «не заполнили».',
    900,
    13,
    { fill: C.muted, lineHeight: 19 },
  );
  ...
  b += paragraph(82, 1070, 'Можно оставить пустым и уточнить совместимость позже.', 522, 12, {
    fill: C.muted,
    lineHeight: 18,
  });
  ...
  b += callout(
    ...
    '1',
    'Код уникален',
    'Пишите как в учётной системе. Лишние пробелы портал уберёт, регистр приведёт к единому.',
    { fill: C.bluePale, stroke: '#bae0ff' },
  );
  b += callout(
    683,
    ...
    150,
    '2',
    'Цвет — отдельная позиция',
    'Чёрный, голубой, пурпурный и жёлтый — разные коды и разные остатки. Комплект — тоже своя позиция.',
    { fill: C.purpleSoft, stroke: '#d3adf7', dotFill: C.purple },
  );
  b += callout(
    683,
    ...
    138,
    '3',
    'Совместимость кормит подбор',
    'Именно связь с моделями отвечает на вопрос «чем заправлять этот аппарат».',
    { fill: C.greenSoft, stroke: '#b7eb8f', dotFill: C.green },
  );
  ...
  b += paragraph(
    82,
    1236,
    'Снятое «Активен» убирает позицию из подбора и из плановой закупки, но сохраняет остаток, совместимость и всю историю движений. Именно так поступают с кодом, который больше не покупают.',
    436,
    14,
    { fill: C.text, lineHeight: 21 },
  );
  b += paragraph(
    82,
    1356,
    'Удаление оставлено ошибочно заведённой строке — той, по которой ничего не было.',
    436,
    13.5,
  ...
  b += bullet(605, 1246, 'По позиции было движение остатка — журнал не подчищают.', 436, {
    color: C.red,
    size: 13.5,
    lineHeight: 19,
  });
  b += bullet(605, 1310, 'Позиция стоит в открытой закупке — портал назовёт её номер.', 436, {
    color: C.red,
    size: 13.5,
    lineHeight: 19,
  });
  b += bullet(605, 1374, 'Позиция стоит в любой закупке — удалить нельзя даже закрытую.', 436, {
    color: C.red,
    size: 13.5,
    lineHeight: 19,
  });
...
function page14() {
  ...
  b += pill(510, 326, '☑  Есть дефицит', {
    fill: C.blueSoft,
    color: C.blue,
    stroke: '#91caff',
    size: 12,
  }).svg;
  b += pill(670, 326, '□  Нет в наличии', {
    fill: C.graySoft,
    color: C.text,
    stroke: '#d9d9d9',
    size: 12,
  }).svg;
  b += pill(839, 326, '□  Только активные', {
    fill: C.graySoft,
    color: C.text,
    stroke: '#d9d9d9',
    size: 12,
  ...
  b += tableRow(
    ...
    438,
    widths,
    ['Д0000337741', 'Тонер Ricoh 201', '12', '20', '4', '4', '24.08.2026 11:42', '№   ⛁   ⏱'],
    {
      height: 52,
      fill: '#fcfdff',
      top: 26,
      weights: [500, 600],
      colors: [C.text, C.text, C.text, C.text, C.text, C.orange],
    },
  );
  b += tableRow(
    82,
    490,
    widths,
    ['Б0000014256', 'Картридж Ricoh 1270D', '0', '6', '—', '6', '02.07.2026 16:20', '№   ⛁   ⏱'],
    { height: 52, top: 26, colors: [C.text, C.text, C.red, C.text, C.faint, C.orange] },
  );
  b += tableRow(
    82,
    542,
    widths,
    ['Д0000337810', 'Тонер Kyocera TK-3160', '4', '—', '—', '—', '—', '№   ⛁   ⏱'],
    {
      height: 52,
      fill: '#fcfdff',
      top: 26,
      colors: [C.text, C.text, C.text, C.faint, C.faint, C.faint, C.faint],
    },
  );
  b += tableRow(
    82,
    594,
    widths,
    ['Д0000341142', 'Тонер Ricoh MP C2503', '2', '8', '6', '—', '19.08.2026 09:05', '№   ⛁   ⏱'],
    { height: 52, top: 26, colors: [C.text, C.text, C.text, C.text, C.text, C.faint] },
  );
  b += paragraph(
    82,
    668,
    'Действия строки: «№» — «Изменить остаток», «⛁» — «Потребность», «⏱» — «История остатка».',
    900,
    13,
    { fill: C.muted, lineHeight: 19 },
  );
  ...
  const cols = [
    [
      'Наличие',
      'Сколько лежит на полке. Прямо в таблице не правится: остаток меняется событием с причиной, а не ячейкой.',
      C.blue,
      C.bluePale,
      '#bae0ff',
    ],
    [
      'Потребность',
      'Сколько позиции хотим держать на полке. Ноль означает «не следим»: такую позицию закупка не предложит.',
      C.purple,
      C.purpleSoft,
      '#d3adf7',
    ],
    [
      'Уже заказано',
      'Сколько стоит в открытых закупках — «Новых» и «В работе». Закрытая и отменённая не считаются.',
      C.orange,
      C.orangeSoft,
      '#ffd591',
    ],
    [
      'К закупке',
      'Потребность минус наличие минус уже заказанное, но не меньше нуля. Столько и предложит форма закупки.',
      C.green,
      C.greenSoft,
      '#b7eb8f',
    ],
    [
      'Правка остатка',
      'Когда остаток последний раз правили руками. Выдачи и возвраты по заявкам сюда не считаются; прочерк — «не трогали ни разу».',
      C.cyan,
      C.cyanSoft,
      '#87e8de',
    ],
    [
      'В парке',
      'Сколько подходящих аппаратов стоит в вашей области видимости. Ноль значит «у вас таких нет», а не «позиция ничему не подходит».',
      C.faint,
      C.graySoft,
      '#d9d9d9',
    ],
  ...
  cols.forEach((col, i) => {
    ...
    b += text(x + 22, y + 42, col[0], 18, {
      fill: col[2] === C.faint ? C.muted : col[2],
      weight: 700,
    });
    b += line(x + 22, y + 58, x + 309, y + 58, { stroke: col[4] });
    b += paragraph(x + 22, y + 88, col[1], 287, 13.5, {
      fill: C.text,
      lineHeight: 20,
      maxLines: 6,
    });
  ...
  b += paragraph(
    82,
    1266,
    '«Есть дефицит» и «Нет в наличии» — разные вопросы. Позиция с потребностью 20 и остатком 5 в наличии есть, а заказывать её надо; позиция с нулевой потребностью и пустой полкой в наличии отсутствует, но дефицита у неё нет — за ней не следят.',
    950,
    14,
    { fill: C.text, lineHeight: 21 },
  );
  ...
  b += paragraph(
    82,
    1404,
    'Вторая половина вкладки — список плановых закупок; она открыта только тому, кто их ведёт. Кнопка «Плановая закупка» видна из обеих половин: закупку заводят, глядя на дефицит.',
    950,
    14,
    { fill: C.muted, lineHeight: 21 },
  );
...
function page15() {
  ...
  b += paragraph(
    82,
    528,
    'Куда ушло или откуда пришло: «выдано на АЛ13», «поступление по счёту 1245».',
    386,
    12.5,
    { fill: C.muted, lineHeight: 19 },
  );
  ...
  b += paragraph(
    104,
    632,
    'Портал покажет новое текущее значение и попросит свериться перед сохранением.',
    342,
    12,
    { fill: C.text, lineHeight: 17 },
  );
  ...
  const entries = [
    [
      '24.08.2026 11:42',
      '12 → 18',
      'Поступление по счёту 1245',
      'Иванов И. И. · Штаб · Оргтехника: номенклатура',
      C.green,
    ],
    [
      '21.08.2026 09:14',
      '13 → 12',
      'Выдача по заявке СО-398',
      'Заявка открывается по ссылке',
      C.blue,
    ],
    [
      '14.08.2026 16:05',
      '10 → 13',
      'Возврат по заявке СО-390',
      'Номер без ссылки: заявка вам не видна',
      C.faint,
    ],
  ];
  ...
  b += text(585, 716, '1–50 из 128 · страницами, сверху последние события', 12.5, {
    fill: C.muted,
  });
  ...
  b += callout(
    ...
    200,
    '1',
    'Журнал по одной позиции',
    'Общего журнала по всем расходникам нет: ленту открывают кнопкой в строке той позиции, чей остаток разбирают.',
    { fill: C.bluePale, stroke: '#bae0ff' },
  );
  b += callout(
    396,
    ...
    200,
    '2',
    'Ссылка на заявку честная',
    'Номер заявки стоит всегда, а ссылкой становится только тогда, когда смотрящий эту заявку может открыть. Иначе номер остаётся текстом.',
    { fill: C.purpleSoft, stroke: '#d3adf7', dotFill: C.purple },
  );
  b += callout(
    737,
    ...
    '3',
    'Подпись — сегодняшняя',
    'Роль и наборы полномочий у автора события показаны нынешние: кем человек был на момент правки, портал не хранит.',
    { fill: C.greenSoft, stroke: '#b7eb8f', dotFill: C.green },
  );

  b += rect(55, 1070, 1013, 174, { fill: C.cyanSoft, stroke: '#87e8de', r: 16 });
  b += text(82, 1114, 'Ручная правка и движение по заявке — разные события', 20, {
    fill: C.cyan,
    weight: 700,
  });
  b += paragraph(
    82,
    1148,
    'Выдача картриджа по заявке уменьшает остаток сама, когда исполнитель отмечает выдачу при закрытии работ. В столбец «Правка остатка» такие события не попадают: он отвечает на вопрос «когда мы сами пересчитывали полку», и разница между «менялся» и «правили руками» — это весь смысл столбца.',
    950,
    15,
    { fill: C.text, lineHeight: 22 },
  );
  ...
  b += bullet(
    82,
    1354,
    'Читают журнал все, кому видна сама позиция: своего доступа у ленты нет.',
    470,
    { color: C.blue, size: 14, lineHeight: 20 },
  );
  b += bullet(
    565,
    1354,
    'Правят остаток — только держатели набора «Оргтехника: номенклатура».',
    470,
    { color: C.green, size: 14, lineHeight: 20 },
  );
  b += bullet(82, 1406, 'Причина обязательна и короче трёх знаков не принимается.', 470, {
    color: C.blue,
    size: 14,
    lineHeight: 20,
  });
  b += bullet(565, 1406, 'Событие «0 → 0» журнал не пропускает: менять нечего.', 470, {
    color: C.green,
    size: 14,
    lineHeight: 20,
  });
...
function page16() {
  ...
  b += paragraph(
    82,
    442,
    'Ноль означает «не следим»: такую позицию плановая закупка не предложит, даже если полка пуста.',
    386,
    12.5,
    { fill: C.muted, lineHeight: 19 },
  );
  ...
  b += text(813, 340, 'потребность − наличие − уже заказано', 19, {
    fill: C.blue,
    weight: 700,
    anchor: 'middle',
  });
  ...
  b += paragraph(
    585,
    424,
    'Уже заказанное вычитается специально: без этого портал звал бы заказать второй раз то, что уже везут. Именно поэтому закрытая закупка перестаёт вычитаться — считается, что приход по ней уже занесён.',
    456,
    14,
    { fill: C.text, lineHeight: 21 },
  );
  ...
  const rows = [
    ...
    [
      'Тонер Ricoh MP C2503',
      '2',
      '8',
      '6',
      '— уже везут ровно столько, сколько не хватает',
      C.muted,
    ],
  ];
  rows.forEach((row, i) => {
  ...
  b += paragraph(
    82,
    1014,
    'У позиции с нулевой потребностью дефицита не бывает никогда, и в форму закупки она не попадает. Так помечают то, что покупают под конкретный случай, а не держат на полке.',
    436,
    14,
    { fill: C.text, lineHeight: 21 },
  );
  b += paragraph(
    82,
    1112,
    'В таблице такой ноль показан прочерком: «не следим», а не «нужно ноль штук».',
    436,
    13,
    { fill: C.muted, lineHeight: 19 },
  );
  ...
  b += paragraph(
    605,
    1014,
    'Окно «Потребность» показывает наличие, уже заказанное и текущий дефицит рядом с полем: держать их в голове или возвращаться в таблицу не нужно.',
    436,
    14,
    { fill: C.text, lineHeight: 21 },
  );
  b += paragraph(605, 1112, 'Кто правит потребность — тот же, кто ведёт номенклатуру.', 436, 13, {
    fill: C.muted,
    lineHeight: 19,
  });

  b += rect(55, 1208, 1013, 234, { fill: '#fff', stroke: C.line, r: 16 });
  b += text(82, 1252, 'Зачем вообще потребность, если есть остаток', 20, {
    fill: C.ink,
    weight: 700,
  });
  b += paragraph(
    82,
    1286,
    'Пустой остаток не говорит, надо ли заказывать: у одной позиции ноль — это авария, у другой — норма. Потребность отвечает на этот вопрос один раз и за всех, и именно она превращает перечень картриджей в план закупки.',
    950,
    15,
    { fill: C.text, lineHeight: 22 },
  );
  b += paragraph(
    82,
    1362,
    'В карточке позиции потребность стоит обычным полем; на вкладке «Расходники» её правят отдельным действием строки — там, где на дефицит и смотрят.',
    950,
    14,
    { fill: C.muted, lineHeight: 21 },
  );
...
function page17() {
  ...
  b += statusBox(400, 430, 230, 90, 'Отменена', 'снята с причиной', {
    color: C.red,
    soft: C.redSoft,
    stroke: '#ffccc7',
  });
  ...
  b += paragraph(
    660,
    452,
    'Отменить можно из «Новой» и «В работе», причина обязательна: «заказали напрямую у поставщика по счёту 1245».',
    400,
    13.5,
    { fill: C.text, lineHeight: 20 },
  );
  b += paragraph(
    660,
    520,
    'Закрытая и отменённая — конечные: ошибку исправляют новой закупкой.',
    400,
    13,
    { fill: C.muted, lineHeight: 19 },
  );
  ...
  b += text(
    82,
    630,
    'Форма открывается уже заполненной: в ней те позиции, у которых есть дефицит',
    13,
    { fill: C.muted },
  );
  ...
  b += tableRow(
    ...
    692,
    widths,
    ['Тонер Ricoh 201', 'потребность 20 − наличие 12 − заказано 4', '4', '4'],
    { height: 52, fill: '#fcfdff', top: 26, size: 13, weights: [600] },
  );
  b += tableRow(82, 744, widths, ['Картридж Ricoh 1270D', 'потребность 6 − наличие 0', '6', '6'], {
    height: 52,
    top: 26,
    size: 13,
    weights: [600],
  });
  b += tableRow(82, 796, widths, ['Тонер HP 106A', 'потребность 4 − наличие 1', '3', '10'], {
    height: 52,
    fill: '#fcfdff',
    top: 26,
    size: 13,
    weights: [600],
    colors: [C.ink, C.text, C.text, C.orange],
  });
  b += text(82, 884, 'Итого позиций: 3', 15, { fill: C.ink, weight: 700 });
  b += text(240, 884, 'Заказать больше, чем предлагает портал, можно — это ваше решение', 13, {
    fill: C.muted,
  });
  b += input(82, 928, 470, '', 'Дописать позицию (только действующие)', {
    placeholder: true,
    height: 42,
    suffix: '⌄',
  });
  b += input(572, 928, 300, '', 'К чему закупка — необязательно', {
    placeholder: true,
    height: 42,
  });
  ...
  b += paragraph(
    82,
    1104,
    'Ни вложений, ни обсуждения, ни срочности, ни заморозки, ни писем. В общем списке заявок её тоже нет — это другой документ. Счёт от поставщика подшивают в учётной системе.',
    436,
    14,
    { fill: C.text, lineHeight: 21 },
  );
  ...
  b += paragraph(
    605,
    1104,
    'По набору «Оргтехника: ведение», и только по нему: у документа нет площадки и отдела, а значит и области видимости, по которой его можно было бы делить.',
    436,
    14,
    { fill: C.text, lineHeight: 21 },
  );
  ...
  b += bullet(
    82,
    1330,
    '«Править» — только в «Новой»: после проведения бумага уже у снабжения.',
    470,
    { color: C.blue, size: 14, lineHeight: 20 },
  );
  b += bullet(
    565,
    1330,
    '«Провести» — передать состав снабжению; закупка становится «В работе».',
    470,
    { color: C.orange, size: 14, lineHeight: 20 },
  );
  b += bullet(
    82,
    1394,
    '«Закрыть» — только из «В работе» и только с подтверждением (стр. 18).',
    470,
    { color: C.green, size: 14, lineHeight: 20 },
  );
  b += bullet(565, 1394, '«Отменить» — из «Новой» и «В работе», с обязательной причиной.', 470, {
    color: C.red,
    size: 14,
    lineHeight: 20,
  });
...
function page18() {
  ...
  b += paragraph(
    136,
    352,
    'Занесите приход ручной правкой остатка и только потом закрывайте: закрытая перестаёт вычитаться из дефицита.',
    470,
    12.5,
    { fill: C.text, lineHeight: 18 },
  );
  const widths = [280, 130, 136];
  b += tableHeader(82, 414, widths, ['Позиция', 'Заказано', 'На складе сейчас']);
  b += tableRow(82, 456, widths, ['Тонер Ricoh 201', '4', '18'], {
    height: 46,
    fill: '#fcfdff',
    top: 27,
    size: 13,
  });
  b += tableRow(82, 502, widths, ['Картридж Ricoh 1270D', '6', '6'], {
    height: 46,
    top: 27,
    size: 13,
  });
  ...
  b += check(87, 581, '#fff');
  b += text(116, 588, 'Приход по этой закупке занесён в остатки', 15, {
    fill: C.text,
    weight: 500,
  });
  b += paragraph(
    82,
    616,
    'Портал не может это проверить и не притворяется, что может: остаток не доказывает, по какой закупке он вырос.',
    546,
    12.5,
    { fill: C.muted, lineHeight: 18 },
  );
  ...
  b += paragraph(
    780,
    356,
    'Кнопкой «Изменить остаток» в перечне расходников: новое количество и причина со ссылкой на счёт.',
    262,
    13,
    { fill: C.muted, lineHeight: 19 },
  );
  ...
  b += paragraph(
    780,
    522,
    'Кнопка «Закрыть» в карточке ЗК и галочка-подтверждение. После этого закупка перестаёт вычитаться из дефицита.',
    262,
    13,
    { fill: C.muted, lineHeight: 19 },
  );
  ...
  b += paragraph(
    730,
    626,
    'Оба шага делает один и тот же человек — тот, кто ведёт модуль.',
    292,
    13,
    { fill: C.text, lineHeight: 19 },
  );
  ...
  b += text(142, 780, 'Что будет, если закрыть раньше, чем занесли приход', 22, {
    fill: C.ink,
    weight: 700,
  });
  b += paragraph(
    142,
    812,
    'Закрытая закупка перестаёт считаться «уже заказанным». Дефицит по позиции тут же вырастет обратно, форма плановой закупки предложит её снова — и её закажут второй раз. Ошибка тихая: портал не отличит новую потребность от незанесённого прихода.',
    900,
    15,
    { fill: C.text, lineHeight: 22 },
  );
  b += paragraph(
    142,
    906,
    'Лечится это тем же ручным приходом: занесите поступившее количество, и дефицит сойдётся сам.',
    900,
    14,
    { fill: C.muted, lineHeight: 21 },
  );
  ...
  b += paragraph(
    55,
    1044,
    'Между тем, как закупку провели, и тем, как её закрывают, остаток живёт своей жизнью: по нему шли выдачи по заявкам, ручные корректировки и, возможно, приход по соседней закупке. Выросшее число не доказывает, что выросло оно именно по этой бумаге, — поэтому портал спрашивает подтверждение человека, а не считает сам. Галочка делает ровно две вещи: заставляет прочитать правило в момент, когда оно применяется, и оставляет имя того, кто это утверждал.',
    1013,
    15,
    { fill: C.text, lineHeight: 23 },
  );
  ...
  b += paragraph(
    82,
    1252,
    '«Больше не покупаем» и «уже заказали и ждём» — прямое противоречие. Портал назовёт номер: «По позиции открыта закупка ЗК-14 — закройте или отмените её».',
    436,
    14,
    { fill: C.muted, lineHeight: 21 },
  );
  b += paragraph(
    82,
    1350,
    'Номер в тексте и есть ответ: идти надо именно в эту закупку.',
    436,
    13,
    { fill: C.text, lineHeight: 20 },
  );
  ...
  b += paragraph(
    605,
    1252,
    'Здесь строже: держат и закрытая, и отменённая. Документ не должен указывать на пустоту — иначе через год состав закупки нечем будет прочитать.',
    436,
    14,
    { fill: C.muted, lineHeight: 21 },
  );
  b += paragraph(
    605,
    1350,
    'Если позиция больше не нужна — снимите «Активен», а не удаляйте.',
    436,
    13,
    { fill: C.text, lineHeight: 20 },
  );
...
function page19() {
  ...
  panels.forEach((panel) => {
    ...
    b += text(panel.x + 24, 274, panel.title, 24, {
      fill: panel.color === C.faint ? C.muted : panel.color,
      weight: 700,
    });
    b += paragraph(panel.x + 24, 350, panel.lead, 283, 14, {
      fill: C.muted,
      lineHeight: 20,
      maxLines: 3,
    });
  ...
  b += text(82, 940, 'Обсуждение, документы и история — внутри карточки заявки', 20, {
    fill: C.blue,
    weight: 700,
  });
  b += paragraph(
    82,
    974,
    'В карточке живут вкладки «Заявка», «Расходники» (у расходников) или «Объём работ» (у ремонта сервисной компании), «Документы» и «История», а рядом с действиями — «Обсуждение»: лента сообщений с адресатами. Документы подшивают через «Фото и документы» при заведении и на вкладке «Документы» после него, где у каждого файла есть вид: акт, счёт, гарантийный талон.',
    950,
    15,
    { fill: C.text, lineHeight: 22 },
  );
  ...
  b += bullet(82, 1204, 'История обслуживания прямо в карточке аппарата.', 436, {
    color: C.blue,
    size: 14,
    lineHeight: 20,
  });
  b += bullet(82, 1256, 'Отчёт по расходу расходников за период.', 436, {
    color: C.blue,
    size: 14,
    lineHeight: 20,
  });
  b += bullet(82, 1308, 'Повторная отправка письма службе — если задание потерялось.', 436, {
    color: C.blue,
    size: 14,
    lineHeight: 20,
  });
  b += bullet(82, 1372, 'Запись перемещения техники прямо из карточки заявки.', 436, {
    color: C.blue,
    size: 14,
    lineHeight: 20,
  });
  ...
  b += paragraph(
    605,
    1196,
    'Если заявитель отметил, что аппарат стоит не там, где записано в карточке, заявка получает пометку. Справочник она не правит: перенос единицы — решение ИТ-службы после проверки, а не следствие галочки в заявке.',
    436,
    14,
    { fill: C.text, lineHeight: 21 },
  );
  b += paragraph(
    605,
    1322,
    'Пометка гаснет сама, когда карточку поправили: она сравнивает объект заявки с сегодняшней карточкой, а не хранит вечное «когда-то не совпало».',
    436,
    13.5,
    { fill: C.muted, lineHeight: 20 },
  );
...
function page20() {
  ...
  cases.forEach((item, i) => {
    ...
    b += paragraph(x + 82, y + 42, item.title, 380, 18, {
      fill: C.ink,
      weight: 700,
      lineHeight: 24,
      maxLines: 2,
    });
    b += paragraph(x + 30, y + 108, item.body, 436, 13.5, {
      fill: C.text,
      lineHeight: 20,
      maxLines: 5,
    });
  ...
  b += text(82, 978, 'Ещё три сообщения, которые не означают поломку', 20, {
    fill: C.ink,
    weight: 700,
  });
  b += bullet(
    82,
    1020,
    '«Черновик изменил другой человек» — закупку правил кто-то ещё; перечитайте состав и сохраните заново.',
    950,
    { color: C.muted, size: 14, lineHeight: 20 },
  );
  b += bullet(
    82,
    1072,
    '«Пока окно было открыто, остаток изменил другой человек» — сверьтесь с новым числом и повторите правку.',
    950,
    { color: C.muted, size: 14, lineHeight: 20 },
  );
  b += bullet(
    82,
    1124,
    '«Закупку уже провели» — состояние документа изменилось, пока карточка была открыта; обновите её.',
    950,
    { color: C.muted, size: 14, lineHeight: 20 },
  );
  ...
  b += bullet(
    82,
    1268,
    'Набора полномочий нет — его выдаёт администратор портала поимённо, в карточке учётки.',
    470,
    { color: C.blue, size: 14, lineHeight: 20 },
  );
  b += bullet(
    565,
    1268,
    'Позиции нет в справочнике — её заводят в «Картриджи и тонеры», а не на вкладке.',
    470,
    { color: C.purple, size: 14, lineHeight: 20 },
  );
  b += bullet(
    82,
    1332,
    'Аппарата нет в справочнике — его заводят в «Справочники» → «Оргтехника».',
    470,
    { color: C.green, size: 14, lineHeight: 20 },
  );
  b += bullet(
    565,
    1332,
    'Заявку завели не на то — её отменяет «Ведение», причина обязательна.',
    470,
    { color: C.orange, size: 14, lineHeight: 20 },
  );
  b += paragraph(
    82,
    1400,
    'Руководства портала лежат в служебном меню: там же обновляется и это.',
    950,
    13.5,
    { fill: C.muted, lineHeight: 20 },
  );
