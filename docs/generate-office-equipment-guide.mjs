...
function footer(label = 'Инструкция • оргтехника и заявки • 28.08.2026') {
  return (
...
function page1() {
  ...
  b += text(55, 1435, 'Редакция: 28 августа 2026', 15, { fill: C.faint });
  b += text(1068, 1435, '16 страниц', 15, { fill: C.faint, anchor: 'end' });
  b += footer('Пользовательская инструкция • 28.08.2026');
  return document(b);
}
...
function page16() {
  ...
  const ready = [
    ...
    'обсуждение заявки вместо примечания исполнителя, метки непрочитанного и «Отметить все прочитанными».',
  ];
  ...
  b += footer('Инструкция • целевой пользовательский поток • 28.08.2026');
  return document(b);
}
...
const fixedDate = new Date('2026-08-28T12:00:00+05:00');
