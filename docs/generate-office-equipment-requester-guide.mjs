...
function page1() {
  ...
  const notes = [
    ...
    [
      ...
      'Галочка открывает поле «Почему срочно», и без него заявка не отправится. Причину читают: по ней решают, чем заняться раньше, и «просто так» отнимает внимание у тех, у кого работа встала.',
      C.orange,
      C.orangeSoft,
      '#ffd591',
    ],
...
function page4() {
  ...
  const qa = [
    ...
    [
      ...
      'Когда работа встала: «единственный принтер на площадке, встала выдача пропусков». Причина обязательна, и её читают; сама по себе метка заявку в списке выше не поднимает.',
      C.gold,
      C.goldSoft,
      '#ffe58f',
    ],
