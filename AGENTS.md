...
**Работа записывается в журнал задач.** `.local/tasks/current.md` — карточки по статусам,
`.local/tasks/archive.md` — готовое старше семи дней, `.local/tasks/README.md` — форма записи;
каталог вне истории. Тронули задачу — в том же заходе обновите карточку; при каждой правке журнала
увозите в архив перезревшее без хвостов и очистки.
