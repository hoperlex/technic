 ...
 *
 * Возврат всегда с прямыми косыми: маски политик пишутся в одном виде, и сравнивать их с
 * разделителями конкретной файловой системы значило бы получать разный ответ на разных машинах.
 */
